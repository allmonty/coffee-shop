"""Customer identity and visit lifecycle (spec §4.1, §7.1).

Reached through `shop.service`, which is the import surface for the whole
domain. This module has no idea an LLM exists.
"""
